...
<div id="titleBar" class="title-bar">
  <div class="container content">
  	<?php // put the messages up higher on the page if it's the home page
    if ($is_front == 1):
    	if ($messages): ?>
      ...
      <div id="content" class="mc-content <?php if (($page['sidebar_first']) && ($page['sidebar_second'])): print 'span6'; elseif (($page['sidebar_first']) || ($page['sidebar_second'])): print 'span9'; else: print 'span12'; endif; ?>">
        <div id="content-wrapper" class="content-wrapper">
          <div id="content-head" class="row-fluid content-head">
            ...
            <?php endif; ?>
            <?php if ($is_front == 0): // if it's not the front page, show the messages (matches up with the earlier Title Bar messages switch for the home page ?>
            	<?php if ($messages): ?>
            		<div id="console" class="clearfix"><?php print $messages; ?></div>
            	<?php endif; ?>
            <?php endif; ?>
